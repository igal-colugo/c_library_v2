...
#define MAVLINK_THIS_XML_HASH -1518418281553369171
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_ASIO_SET_SENSOR=40601, /* Selecting sensor. Require reset after set || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_REC=40602, /* Selecting logging mode. Require reset after set || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_NAV_MODE=40603, /* Selecting navigation mode. Require reset after set || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_INIT_LOC=40604, /* Selecting initial location. set 0 to clear |Empty| Empty| Empty| Empty| Latitude| Longitude| Altitude (Note: not implemented on Asio side)|  */
   MAV_CMD_ASIO_RESET=40605, /* Reset |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_CAL=40606, /* Initiate calibration of installation angles |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_SLAM_MODE=40607, /* Enabling Force SLAM mode || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_SLAM_TIMEOUT=40608, /* Set timeout to SLAM mode. After timeout, if GPS is valid, take GPS data, othewise keep SLAM || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_MAP_WARNING_RANGE=40609, /* Range in meters around the current drone location to send "edge of map" warning || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASIO_SET_DB_REC=40610, /* Not Implemented - DO NOT USE || Empty| Empty| Empty| Empty| Empty| Empty|  */
   ...
   MAV_CMD_CE367_SET_STARTER=60601, /* Start,stop,reset starter command || Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENUM_END=60602, /*  | */
} MAV_CMD;
#endif
